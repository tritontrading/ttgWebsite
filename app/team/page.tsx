    ...
    <main className="min-h-screen bg-cream">
      ...
      <section className="border-b border-[#080808]/20 px-5 py-20 md:px-12 md:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-px bg-[#080808]/8 md:grid-cols-2 lg:grid-cols-3">
            {EXEC_BOARD.map((member) => (
              <div key={member.role} className="flex flex-col gap-3 bg-cream p-6 md:p-8">
      ...
      <section className="border-b border-[#080808]/20 bg-cream px-5 py-20 md:px-12 md:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-px bg-[#080808]/8 md:grid-cols-2">
      ...
      <section className="border-b border-[#080808]/20 px-5 py-20 md:px-12 md:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 items-start gap-12 md:gap-20 lg:grid-cols-2">
            ...
            <div className="grid grid-cols-1 gap-px bg-[#080808]/8 sm:grid-cols-2">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="flex flex-col gap-2 bg-cream p-6">
      ...
      <section className="border-b border-[#080808]/20 bg-cream px-5 py-20 md:px-12 md:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-px bg-[#080808]/8 md:grid-cols-3">
            {MEMBER_CLASSES.map((cls) => (
              <div key={cls.year} className="bg-cream p-6 md:p-8">
