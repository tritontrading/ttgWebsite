        ...
        <div className="mx-auto max-w-7xl">
          ...
          <ScrollReveal className="grid grid-cols-1 gap-px bg-[#080808]/8 md:grid-cols-2 lg:grid-cols-3" stagger={0.08}>
            {EXEC_BOARD.map((member, index) => (
              ...
              >
                <div className="relative aspect-[2/3] w-full overflow-hidden bg-[#eff0e7]">
                  {member.photo ? (
                    <Image
                      src={member.photo}
          ...
          <ScrollReveal className="grid grid-cols-1 gap-px bg-[#080808]/8 md:grid-cols-2 lg:grid-cols-3" stagger={0.08}>
            {BOARD_MEMBERS.map((member, index) => (
              <div
                key={member.role}
                data-reveal
                className={`card-hover flex flex-col overflow-hidden bg-cream${index === BOARD_MEMBERS.length - 1 && BOARD_MEMBERS.length % 3 === 1 ? ' lg:col-start-2' : ''}`}
              >
                <div className="relative aspect-[2/3] w-full overflow-hidden bg-[#eff0e7]">
                  {member.photo ? (
                    <Image
